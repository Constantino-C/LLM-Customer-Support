...
def main(data: str, adapter_path: str, base_model: str = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"):
    ...
    for k in FIELDS:
        ...
        if pairs:
            ...
            print(f"{k} F1: 0.000 no valid predictions")


if __name__ == "__main__":
    ap = argparse.ArgumentParser()
    ap.add_argument("--data", type=str, default="data/synthetic_val_pairs.jsonl")
    ap.add_argument("--adapter_path", type=str, default="outputs/lora-adapter")
